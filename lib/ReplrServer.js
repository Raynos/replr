...
(function() {
  ...
  ReplrServer = (function(_super) {
    ...
    ReplrServer.prototype.OPTIONS_REPL_KEYS = ['port', 'prompt', 'terminal', 'useColors'];
    ...
    ReplrServer.prototype.start = function(callback) {
      ...
      onVerified = function(err, status) {
        ...
        try {
          return _this.socketServer.listen(_this.options.port);
        } catch (_error) {
          err = _error;
          _this.started = false;
          _this.starting = false;
    ...
    ReplrServer.prototype.open = function(socket) {
      var client, exports, key, r, replOptions, value, _i, _len, _ref, _ref1,
        _this = this;
      replOptions = {};
