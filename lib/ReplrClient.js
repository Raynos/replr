...
(function() {
  var ReplrClient, cluster, colors, doc, terminal;
  ...
  ReplrClient = (function() {
    ...
    ReplrClient.prototype.exports = function() {
      var cmds, exports, select, vars, workers,
        _this = this;
      cmds = function() {
        ({
    ...
    ReplrClient.prototype.getCommands = function() {
      var commands, described, descriptions, exported, func, indentBy, longest, signature, signatureAsString, _i, _j, _len, _len1;
    ...
    ReplrClient.prototype.getWelcomeMessage = function(callback) {
      ...
      if (cluster.isMaster) {
        return this.getWorkersDescription(function(description) {
          return callback("" + title + " " + _this.options.name + "[Cluster]\n\n" + (_this.indent(description, 2)) + "\n\n" + hint + "\n\n" + _this.repl.prompt);
        });
      } else {
